...
declare module linqjs {
    ...
    export interface OrderedEnumerable extends Enumerable {
    ...
    export interface DisposableEnumerable extends Enumerable {
        dispose(): void;
    }
    ...
    export interface Grouping extends Enumerable {
        key(): any;
    }
}
